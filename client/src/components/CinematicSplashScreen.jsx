    ...
    >
      ...
      <style>{`
        ...
        @keyframes dropFallAnimation {
          ...
          100% {
            transform: translateY(14px) scale(1.35, 0.45); /* Flattens on impact */
            opacity: 1;
          }
        }
        ...
        /* Ground Splatter Group - Triggers right on drop impact at 1.2s */
        ...
        /* 20 Sub-Small Droplets Bursting All Over Floor at 1.2s */
        .splatter-drop {
          position: absolute;
          border-radius: 50%;
        ...
        /* ── Stage 2 Main Orbital Galaxy Layout ── */
        .splash-main-content {
          display: flex;
          flex-direction: column;
          align-items: center;
